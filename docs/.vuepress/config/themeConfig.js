...
const themeConfig = {
  ...
  logo: 'https://wiki-1251603812.cos.ap-shanghai.myqcloud.com/images/logo.png', // 导航栏logo
  repo: 'p0josec/p0josec.github.io', // 导航栏右侧生成Github链接
  ...
  indexImg: {
    ...
    desc: [ "欲买桂花同载酒，终不似、少年游。"],  // 多个描述，如果填写则覆盖 config.js 的 description，不填写默认读取 config.js 的 description，descFadeIn 为 true 生效
...
blogInfo: {
  ...
  bodyBgImg: 'https://wiki-1251603812.cos.ap-shanghai.myqcloud.com/images/bg.jpeg',  // 你的图片路径(必须位于 public 下)，可以是 URL
  ...
  // 博主信息 (显示在首页侧边栏)
  blogger: {
    avatar: 'https://wiki-1251603812.cos.ap-shanghai.myqcloud.com/images/avatar.jpg',
    name: 'p0jo',
    slogan: '欲变世界，先变自己。',
  },
