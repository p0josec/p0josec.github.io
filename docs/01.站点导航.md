...
```yaml
# - name: 南大程序分析
#   desc: PL,Static Analysis
#   avatar: https://pascal-group.bitbucket.io/img/logo.png # 可选
#   link: https://pascal-group.bitbucket.io/ # 可选
...
::: -->
<ClientOnly>
  <Card :cardData="cardData1024" :cardListSize=3 carTitlColor="#000" carHoverColor="#000" />
</ClientOnly>
...
export default {
    ...
    return {
      ...
      cardData1024: [
        {
          id: '0',
          cardSrc: "https://pascal-group.bitbucket.io/",
          cardImgSrc: "https://pascal-group.bitbucket.io/img/logo.png",
          cardName: "南大程序分析",
          cardContent:
            "PL,Static Analysis",
        },
        {
          id: '1',
          cardSrc: "https://blognas.hwb0307.com/",
          cardImgSrc: "https://blognas.hwb0307.com/logo.jpg",
          cardName: "浮云翩迁之间",
          cardContent:
